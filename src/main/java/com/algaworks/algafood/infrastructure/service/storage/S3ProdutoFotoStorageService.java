...
public class S3ProdutoFotoStorageService implements ProdutoFotoStorageService {
	...
	public void armazenar(NovaFoto novaFoto) {
		try {
			...
			throw new StorageException("Não foi possível finalizar upload no serviço Amazon S3", e);
		}
	}
