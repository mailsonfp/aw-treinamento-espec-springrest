...
public class RestauranteFreteGratisValidator implements ConstraintValidator<RestauranteFreteGratis, Object> {
	private String valorField;
	private String descricaoField;
	private String descricaoObrigatoria;
	
	@Override
	public void initialize(RestauranteFreteGratis constraint) {
